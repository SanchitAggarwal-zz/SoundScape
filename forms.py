...
class InformationForm(Form):
    firstname = TextField("First Name",[validators.Required("First Name Required"),validators.Regexp("^[a-zA-Z]+$",0,"Valid Name")])
    lastname = TextField("Last Name",[validators.Required("Last Name Required"),validators.Regexp("^[a-zA-Z]+$",0,"Valid Name")])
    ...
    contact = IntegerField("Contact",[validators.Required("Contact Required"),validators.NumberRange(1000000000,9999999999,"10 digit Number")])
